...
class DirectSeedView extends StatelessWidget {
  final List<DirectSeedModel> list;
      ...
      child: GridView(
        ...
        children: List.generate(list.length + 1, (index) {
          if (index == 0) {
            ...
            DirectSeedModel model = list[index - 1];
...
class DirectSeedModel {
  ...
  DirectSeedModel.fromJson(Map json) {
  ...
  static List<DirectSeedModel> test() {
    return [
      DirectSeedModel(
